...
expect_true(is.data.frame(geo_connect_csv("D:/Advanced Programming in R/Lab5/address2.txt")))
...
test_that("testing function geo_connect_vector",{
  # address vector
  expect_equal(geo_connect_vector(c("Madrid", "Rydsvagen 254, Linkoping")), 
  ...
  expect_equal(geo_connect_vector(c("Madrid", "58.41236, 15.56107")), 
               data.frame(latitude = c(40.41678, 58.41236), 
                          longitude = c(-3.70379, 15.56107),
                          address = c("Madrid, Spain", 
                                      "Rydsvägen 254, 584 31 Linköping, Sweden"), 
               ...
               tolerance = 0.000001)
  # coordenates vector
  expect_equal(geo_connect_vector(c("40.41678, -3.70379", "58.41236, 15.56107")), 
               data.frame(latitude = c(40.41678, 58.41236), 
                          longitude = c(-3.70379, 15.56107),
...
test_that("testing function geo_connect_csv",{
  ...
  expect_equal(geo_connect_csv("D:/Advanced Programming in R/Lab5/address2.txt"), 
